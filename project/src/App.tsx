...
const WHATSAPP_LINK = `https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20TRIAD%2C%20I%27d%20like%20to%20discuss%20a%20project.`;
            ...
            <form onSubmit={handleFormSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300"
                  placeholder="e.g., $1,500 or 1500-2000"
                />
              </div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <p className="text-gray-400 text-center mb-6">Or reach out to us on social media</p>
                <div className="flex justify-center space-x-6">
                  <motion.a
                    href="https://instagram.com/senpaistudios"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group"
                  ...
                  <motion.a
                    href="https://discord.gg/senpaistudios"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group"
                    whileHover={{ scale: 1.1 }}
                  ...
                  <motion.a
                    href="mailto:hello@senpaistudios.com"
                    className="group"
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
                  >
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <footer className="py-8 px-4 sm:px-6 lg:px-8 border-t border-gray-800">
        <div className="max-w-7xl mx-auto text-center text-gray-400">
          © {new Date().getFullYear()} TRIAD — Crafted with care.
        </div>
      </footer>
    </div>
  );
